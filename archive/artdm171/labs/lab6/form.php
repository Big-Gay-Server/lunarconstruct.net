<?php
	...
	define('DESTINATION_EMAIL','lunarconstruct@gmail.com');
	define('MESSAGE_SUBJECT','Comment from your portfolio website');
	define('REPLY_TO', 'lunar@lunarconstruct.com');
	define('FROM_ADDRESS', 'lunar@lunarconstruct.com');
	define('REDIRECT_URL', 'http://lunarconstruct.com/artdm171/index.html');
